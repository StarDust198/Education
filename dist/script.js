  ...
  bindForms() {
    ...
    this.forms.forEach(form => {
      ...
      form.addEventListener('submit', e => {
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["postData"])('https://jsonplaceholder.typicode.com/posts', json).then(res => console.log(res)).catch(e => console.error(e));
      });
    });
  }
...
class MiniSlider extends _slider__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  bindTriggers() {
    ...
    this.prev.addEventListener('click', () => {
      ...
      this.slides[this.slides.length - 3] : this.slides[this.slides.length - 1];
...
class Slider {
  constructor({
    ...
    this.container = document.querySelector(container);
    this.slides = this.container.children; // this.container.parentElement.querySelectorAll(`${container} > *:not(button)`);
